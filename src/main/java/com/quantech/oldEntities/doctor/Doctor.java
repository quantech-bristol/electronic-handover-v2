...
import com.quantech.oldEntities.handover.Handover;
import com.quantech.oldEntities.patient.Patient;
import com.quantech.oldEntities.team.Team;
import com.quantech.oldEntities.user.UserCore;
...
public class Doctor {
    ...
    public Doctor() {
        ...
        this.lastRenewed = Calendar.getInstance();
